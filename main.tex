...
\begin{figure}[p]
  ...
  \textbf{b}, Weighted phasing graph. Allele nodes are connected by read-supported edges; evidence is weighted by base quality and sequence-context reliability (homopolymers, tandem repeats, miscalled heterozygous sites in copy-number-altered regions) before multi-neighbour haplotype voting and read-based correction.
