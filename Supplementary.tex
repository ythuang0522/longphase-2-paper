...
\todo{Add a panel \textbf{c}: the TP/FP histogram of $\mathrm{MR}$ on HG002, with the 0.7 threshold marked. This figure already exists in the group's algorithm slides and shows the separation directly; regenerate it on the Clair3 calls used here. Without it the threshold is asserted rather than shown.}}
\end{figure}
