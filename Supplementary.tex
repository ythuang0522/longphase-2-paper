...
The strip at the bottom gives the order in which the filters are applied; the copy-number-aware filter (\textbf{e},\textbf{f}) acts last, immediately before graph construction.}
\end{figure}
