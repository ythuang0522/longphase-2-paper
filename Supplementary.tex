...
\begin{figure}[h]
\centering\includegraphics[width=\textwidth]{figures/supp/suppfig1_observations.pdf}
...
\begin{figure}[h]
\centering\includegraphics[width=\textwidth]{figures/supp/suppfig2_pair_support.pdf}
...
\begin{figure}[h]
\centering\includegraphics[width=\textwidth]{figures/supp/suppfig3_voting_entropy.pdf}
...
\begin{figure}[h]
\centering\includegraphics[width=\textwidth]{figures/supp/suppfig4_cnv_filter.pdf}
...
\begin{figure}[h]
\centering\includegraphics[width=\textwidth]{figures/supp/suppfig5_read_correction.pdf}
...
\begin{figure}[h]
\centering\includegraphics[width=\textwidth]{figures/supp/suppfig6_gnn_window.pdf}
...
\textbf{c}, Definition of the central zone. A window holds at most 41 variants and 82 allele nodes, and windows exceeding 256 nodes are skipped; SNV, indel, SV and 5mC records are merged and sorted by position before nodes are created. Edges are the DOT edges with both endpoints in the window, symmetrized, plus one self-loop per node whose features are the mean over that node's incident edges. The predictions of the two allele nodes of a variant are averaged, and a variant covered by several windows receives the mean over those windows.}
\end{figure}

\begin{figure}[h]
\centering\includegraphics[width=\textwidth]{figures/supp/suppfig7_gnn_architecture.pdf}
...
\begin{figure}[h]
\centering\includegraphics[width=\textwidth]{figures/supp/suppfig8_unphase_split.pdf}
...
\begin{figure}[h]
\centering\includegraphics[width=\textwidth]{figures/supp/suppfig9_modcall.pdf}
...
\todo{Four real-data panels exist in the group's thesis and slide material and would replace assertion with evidence throughout this figure. (i)~Per-site scatter of \code{ML} probability at heterozygous versus homozygous CpGs with the 0.8 and 0.2 lines marked, justifying both thresholds and showing that it is the homozygous sites that spread across the ambiguous band; the original was computed on 48 sites in the imprinted \textit{SNRPN} locus, which is too small and too special a sample to stand in a Nature Methods supplement --- recompute genome-wide on HG002. (ii)~Distribution of the linkage ratio $\max(P,Q)/(P+Q)$ stratified by the true class of the site pair (heterozygous--heterozygous, homozygous--homozygous, heterozygous--homozygous). This is the strongest justification available for the 0.9 threshold, because in the original the three classes separate (roughly 0.65--1, 0.5--0.75 and 0.5--0.7), showing that the cut removes homozygous sites misclassified as allele-specific rather than being an arbitrary round number. (iii)~Alignment views of an accepted and a rejected candidate under the two-strand CpG criterion in \textbf{b}. (iv)~A low-coverage example showing the $\max(6,(n_1+n_2)/4)$ span requirement terminating a scan. Regenerate all four with the submitted version on the data used in this paper.}}
\end{figure}

\begin{figure}[h]
\centering\includegraphics[width=\textwidth]{figures/supp/suppfig10_metrics.pdf}
